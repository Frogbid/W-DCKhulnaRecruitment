    ...
    if (isset($_POST['submit'])) {
        ...
        if ($total != 0) {
            while ($result = mysqli_fetch_assoc($data)) {
                ...
                $removedash = str_replace("-", "", $employee_contactno);
                $update_query = "UPDATE `employee_info_table` SET `employee_contactno`='$removedash' WHERE `employee_contactno`='$employee_contactno'";
                    ...
                    <div class="air__subbar">
                        <ul class="air__subbar__breadcrumbs mr-4">
                            <li class="air__subbar__breadcrumb">
                                <a href="#" class="air__subbar__breadcrumbLink air__subbar__breadcrumbLink--current">Removing Dash All of Mobile Numbers</a>
                            </li>
                        </ul>
            ...
            <div class="air__layout__content">
                <div class="air__utils__content">
                    <div class="kit__utils__heading">
                        <h5>
                            <span class="mr-3">Removing Dash All of Mobile Numbers</span>
                        </h5>
                    </div>
                    <div class="card">
                        <div class="card-header bg-dark">
                            <h4 class="mb-0 text-white">Removing Dash All of Mobile Numbers</small></h4>
                        </div>
                        <div class="card-body">
                            <form action="" method="post">
                                <button name="submit" type="submit" class="btn btn-success btn-block">Removing Dash All of Mobile Numbers</button>
                            </form>
                        </div>
                    </div>
                </div>
