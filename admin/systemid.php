    ...
    if (isset($_POST['submit'])) {
        ...
        if ($total != 0) {
            while ($result = mysqli_fetch_assoc($data)) {
                ...
                $mob = md5($roll_no);
                $uniqueid = (rand(100000, 500000));
                $finaluniqueID =  $uniqueid . $mob;

                $update_query = "UPDATE `employee_info_table` SET `system_id`='$finaluniqueID ' WHERE `employee_id`='$employee_id'";
                    ...
                    <div class="air__subbar">
                        <ul class="air__subbar__breadcrumbs mr-4">
                            <li class="air__subbar__breadcrumb">
                                <a href="#" class="air__subbar__breadcrumbLink air__subbar__breadcrumbLink--current">Adding System ID</a>
                            </li>
                        </ul>
            ...
            <div class="air__layout__content">
                <div class="air__utils__content">
                    <div class="kit__utils__heading">
                        <h5>
                            <span class="mr-3">Adding System ID</span>
                        </h5>
                    </div>
                    <div class="card">
                        <div class="card-header bg-dark">
                            <h4 class="mb-0 text-white">Adding System ID</small></h4>
                        </div>
                        <div class="card-body">
                            <form action="" method="post">
                                <button name="submit" type="submit" class="btn btn-success btn-block">Adding System ID</button>
                            </form>
                        </div>
                    </div>
                </div>
