    ...
    if (isset($_POST['submit'])) {
        ...
        if ($total != 0) {
            while ($result = mysqli_fetch_assoc($data)) {
                ...
                $zero = "88";
                $replace = strlen($employee_contactno);
                if ($replace == 11) {
                    $finaloutput = str_replace($employee_contactno, $zero . $employee_contactno, $employee_contactno);
                    $update_query = "UPDATE `employee_info_table` SET `employee_contactno`='$finaloutput' WHERE `employee_id`='$employee_id'";
                    ...
                    <div class="air__subbar">
                        <ul class="air__subbar__breadcrumbs mr-4">
                            <li class="air__subbar__breadcrumb">
                                <a href="#" class="air__subbar__breadcrumbLink air__subbar__breadcrumbLink--current">Adding Zero To All of Mobile Numbers</a>
                            </li>
                        </ul>
            ...
            <div class="air__layout__content">
                <div class="air__utils__content">
                    <div class="kit__utils__heading">
                        <h5>
                            <span class="mr-3">Adding Zero To All of Mobile Numbers</span>
                        </h5>
                    </div>
                    <div class="card">
                        <div class="card-header bg-dark">
                            <h4 class="mb-0 text-white">Adding Zero To All of Mobile Numbers</small></h4>
                        </div>
                        <div class="card-body">
                            <form action="" method="post">
                                <button name="submit" type="submit" class="btn btn-success btn-block">Adding Zero To All of Mobile Numbers</button>
                            </form>
                        </div>
                    </div>
                </div>
